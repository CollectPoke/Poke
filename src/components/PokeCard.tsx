  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden bg-secondary">
        ...
        <span className="mono-num absolute left-2 top-2 rounded bg-background/80 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-foreground backdrop-blur">
          1 / 1
        </span>
        {burned && (
