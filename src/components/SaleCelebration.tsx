  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="sale-celebration-title" className="sale-celebration fixed inset-0 z-[100] flex items-center justify-center overflow-hidden px-5 py-6">
      ...
      <div className="sale-celebration-panel relative w-full max-w-sm text-center">
        ...
        <p className="mt-5 font-display text-sm font-bold uppercase tracking-[0.2em] text-brand">NFT sold!</p>
        ...
        <div className="my-5 rounded-2xl border border-brand/35 bg-brand/10 p-4">
          ...
          <p className="mono-num mt-1 font-display text-4xl font-extrabold text-brand">{price === null ? "—" : formatSolAmount(price)} SOL</p>
          <p className="mt-1 text-xs text-primary-foreground/55">Sent directly to your JPEG wallet</p>
        </div>
        <Button onClick={onClose} className="h-12 w-full rounded-full bg-brand font-display font-bold text-brand-foreground hover:bg-brand/90">Collect & continue</Button>
