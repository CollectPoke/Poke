...
export function MintReveal({ card, onContinue }: { card: CardWithPeople; onContinue: () => void }) {
  useEffect(() => {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="mint-reveal-title" className="mint-reveal fixed inset-0 z-[100] flex items-center justify-center overflow-hidden px-5 py-6">
      ...
      <div className="relative flex h-[min(800px,95dvh)] w-full max-w-sm flex-col items-center justify-center text-center">
        <p className="mint-reveal-kicker font-display text-sm font-bold uppercase tracking-[0.2em] text-poke-yellow">Mint confirmed</p>
        ...
        <div className="mint-reveal-copy">
          ...
          <p className="mt-1 text-sm text-primary-foreground/65">You claimed the name ${card.ticker} before anyone else.</p>
