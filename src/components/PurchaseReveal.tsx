  ...
  return (
    ...
    >
      <div className="w-full max-w-sm text-center">
        ...
        <h2
          id="purchase-reveal-title"
          className="font-display text-3xl font-extrabold text-foreground"
        >
          {card.name} is yours
        </h2>
        <p className="mt-1 text-sm text-muted-foreground">
          The 1/1 NFT has been added to your collection.
        </p>
        <div className="mt-5 flex flex-col items-stretch gap-2">
          <Button
            onClick={onClose}
            className="h-12 rounded-full bg-brand font-display font-bold text-brand-foreground hover:bg-brand/90"
          >
            View my NFT
          </Button>
