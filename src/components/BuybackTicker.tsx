    ...
    <div className="overflow-hidden rounded-2xl border border-white/10 bg-poke-navy text-white shadow-card">
      ...
      <div className="px-5 py-4">
        ...
        {withCta && (
          <Link
            to="/buyback"
            className="mt-4 inline-flex rounded-full bg-poke-yellow px-4 py-2 text-xs font-bold uppercase tracking-widest text-poke-navy transition-transform hover:scale-[1.03]"
          >
            Verify every run →
          </Link>
        )}
